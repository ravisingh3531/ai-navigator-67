...
const courses: Course[] = [
  ...
  {
    rank: 3,
    name: "Data Scientist & AI Engineer Career Tracks",
    provider: "DataCamp",
    score: 7.6,
    fee: "₹12K–₹25K/yr",
    feeFrom: 12000,
    budget: "under-50k",
    level: "absolute",
    levelLabel: "Zero-setup browser exercises from lesson 1",
    mentorship: "self-paced",
    mentorshipLabel: "Self-paced tracks + graded practice, no live mentor",
    career: "minimal",
    careerLabel: "Minimal — certification only, no placement team",
    duration: "4–8 months at 6 hrs/week",
    bestFor: "Cheapest structured way to build real Python + ML skills before paying lakhs",
