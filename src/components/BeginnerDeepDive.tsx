...
const dives: Dive[] = [
  ...
  },
  {
    ...
    anchor: "#review-3",
    bestFor: "Beginners who want to test their aptitude for AI cheaply, and analysts who need hands-on Python/SQL reps",
    beginner: "★★★★★ — the lowest-friction start in this list: code runs in the browser, no installs, no entry test.",
    prereq: "None. Basic school maths is enough; the Python courses assume zero programming.",
    foundation: "Introduction to Python, Data Manipulation with pandas, Statistics and SQL tracks — every lesson is a short video plus an auto-graded coding exercise, so gaps surface immediately instead of at capstone time.",
    curriculum: ["Python", "SQL", "pandas/NumPy", "Statistics", "Supervised + unsupervised ML (scikit-learn)", "Deep learning (PyTorch)", "LLM/GenAI and AI-engineer tracks", "MLOps concepts"],
    projects: "Guided projects and DataLab notebooks; realistic datasets but scoped exercises — you must build 2–3 independent end-to-end deployed projects yourself to be interview-ready.",
    support: "Community forums, hints and solutions inside exercises, certification practice exams. No assigned mentor and no live class.",
    interview: "Certification exams (Data Scientist / AI Engineer Associate and Professional) include a practical exam and case study, but there is no mock-interview drilling like Newton School.",
    placement: "No placement team, no referral pipeline. DataCamp Certified profiles appear on its talent pool; treat that as a lead source, not job assistance.",
    partners: "Enterprise training customers rather than a hiring-partner pipeline for individual learners.",
    rate: "No placement rate is claimed — and that honesty is part of why it ranks here rather than lower.",
    services: ["Skill assessments", "Certification with practical exam", "Portfolio profile", "Job board access"],
    feedback: {
      from: "Commerce graduate working in MIS reporting, 2 years",
      role: "Junior Data Analyst → ML-adjacent work",
      company: "Bengaluru startup (learner interview, June 2026)",
      salary: "₹5.5–7 LPA band",
      note: "Used a ₹18,000 annual subscription to build fundamentals, then interviewed on two self-built projects. Her verdict to me: DataCamp got her fluent, the projects got her hired.",
    },
