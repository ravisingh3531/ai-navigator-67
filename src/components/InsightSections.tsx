  ...
  return (
    <>
      ...
      <p>
        ...
        . Not because it wins every pillar (it does not — Scaler has better placement infrastructure,
        upGrad has the stronger academic tag, DeepLearning.AI is cheaper), but because it is the only
      ...
      <p>
        ...
        placement infrastructure is what you are buying and you can commit 15+ hours a week, Scaler is
        stronger. If your employer or visa process needs a university tag, choose upGrad (IIIT-B) or
...
const faqCards: [string, string, ReactNode][] = [
  [
    ...
    <>
      ...
      more, choose upGrad (IIIT-B) or Great Learning (UT Austin). If budget is under ₹15,000, start with
